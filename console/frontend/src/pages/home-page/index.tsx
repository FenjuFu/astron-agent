...
const HomePage: React.FC = () => {
  ...
  const [bannerList] = useState<Banner[]>([
    // NOTE: isOpen: open new page
    {
      ...
      url: buildAppUrl('/activitySummer'),
      isOpen: false,
    },
    {
      ...
      url: buildAppUrl(
        '/chat?sharekey=e1e62e4027b882aa7a43d4b25ed4974c&botId=2963659'
      ),
      isOpen: false,
    },
    {
      ...
      url: buildAppUrl(
        '/chat?sharekey=b17abc6f0d4a356ed09a9fe1631ffd2c&botId=2958065'
      ),
      isOpen: false,
    },
    {
      ...
      url: buildAppUrl(
        '/chat?sharekey=003e4873f478e5f1f9ed82930d0bb4e7&botId=2216831'
      ),
      isOpen: false,
    },
    {
      ...
      url: buildAppUrl(
        '/chat?sharekey=9991b23791117619a3c3608a44c1c499&botId=2813049'
      ),
      isOpen: false,
    },
  ]);
